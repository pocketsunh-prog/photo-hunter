...
| **卷五・海底尋蹤** | 第 41–50 章 | 海底珊瑚礁、冰灣 | **現生海洋生物**（海豚、礁鯊、章魚、海馬、小丑魚、海龜、海牛、海象…） |

> **目前狀態**：五卷共 **50 章** 全部完成並在兩個 App 上運作（卷一 100 件現代物件、卷二 100 件古代中國文物、卷三 100 件古代非洲文物、卷四 100 隻遠古生物、卷五 100 隻現生海洋生物，共 500 個目標）。
...
卷三（第 21–30 章）、卷四（第 31–40 章）與卷五（第 41–50 章）的關卡地圖與標註複核：

| Web 版 50 章地圖 | 卷四標註複核 | 卷五標註複核 |
|---|---|---|
| ![web 50 章](docs/screenshots/web-13-maps-50.png) | ![卷四複核](docs/screenshots/annotation-check-volume-4.jpg) | ![卷五複核](docs/screenshots/annotation-check-volume-5.jpg) |
...
卷五已標註完成的 10 關（第 41–50 章，珊瑚礁裡找現生海洋生物）：

![卷五標註複核](docs/screenshots/annotation-check-volume-5.jpg)
...
images5/                       卷五 10 張（珊瑚礁，現生海洋生物）
shared/
  levels/level-XX.json         關卡資料：卷別、標題、年代、10 個目標、命中框（唯一真相來源）
  levels/SCHEMA.md             資料格式說明
  assets/images/*.jpg          出貨用相片 1440×1920 + 360×480 縮圖（100 張）
...
**卷五・海底尋蹤**（珊瑚礁裡找現生海洋生物，第 41–50 章）：

| 章 | 標題 | 照片場景 | 找到的海洋生物（例） | 相片 |
|---|---|---|---|---|
| 41 | 第四十一章・珊瑚礁的訪客 | 珊瑚礁 | 海豚、水母、礁鯊、魟魚、海豹、海馬、章魚、海星、蜘蛛蟹、小丑魚 | `images5/生成吉卜力风格古代照片.png` |
| 42 | 第四十二章・礁海現生覓蹤 | 礁海 | 海豚、礁鯊、水母、海馬、熱帶魚、章魚、蝴蝶魚、海豹、小丑魚、螃蟹 | `…(1).png` |
| 43 | 第四十三章・珊瑚礁的現生鄰居 | 珊瑚礁與海面 | 海豚、藍刺尾魚、綠蠵龜、海牛、海豹、海馬、水母、章魚、小丑魚、礁鯊 | `…(2).png` |
| 44 | 第四十四章・珊瑚礁間覓蹤 | 珊瑚礁 | 海豚、礁鯊、魟魚、水母、熱帶魚、章魚、海豹、小丑魚、海馬、龍蝦 | `…(3).png` |
| 45 | 第四十五章・雙髻鯊盤旋的礁岩 | 珊瑚礁 | 海豚、雙髻鯊、海馬、海豹、蝴蝶魚、小丑魚、章魚、紅蝦、海葵、黃尾魚 | `…(4).png` |
| 46 | 第四十六章・礁岩下的現生客 | 礁岩 | 海豚、雙髻鯊、魔鬼魚、海獅、海馬、水母、章魚、小丑魚、龍蝦、蜘蛛蟹 | `…(5).png` |
| 47 | 第四十七章・礁岩間的現生鄰居 | 礁岩 | 海豚、礁鯊、海馬、海豹、海獅、熱帶魚、小丑魚、蜘蛛蟹、魟魚、沙丁魚 | `…(6).png` |
| 48 | 第四十八章・冰灣礁岩尋蹤 | 極地冰灣 | 海豚、海象、礁鯊、海馬、水母、海豹、魟魚、小丑魚、蜘蛛蟹、章魚 | `…(7).png` |
| 49 | 第四十九章・鱸魚巡游的礁岩 | 礁岩 | 海豚、魟魚、章魚、海豹、海馬、小丑魚、蜘蛛蟹、蝦、鱸魚、礁鯊 | `…(8).png` |
| 50 | 第五十章・珊瑚礁現生家園 | 珊瑚礁 | 海豚、海馬、水母、海獅、海豹、章魚、小丑魚、龍蝦、黃鰭鯛、蜘蛛蟹 | `…(9).png` |

> 註：卷五的照片裡同時混了**遠古海洋節肢動物**（三葉蟲、廣翅鱟／海蠍、菊石）當誘餌，
> 那些**不是**目標——十個目標一律是現生種。每一關都是「一物種一隻」，所以畫面裡
> 第二隻海豚、第二隻海豹等不會被列為目標。
...
| 指令 | 用途 |
|---|---|
| `py tools/prepare_assets.py` | 把 `images/`（卷一）到 `images5/`（卷五）五個資料夾的原始相片轉成 1440×1920 主圖 + 360×480 縮圖，並同步到 web 與 android；缺相片會警告並跳過（`--strict` 則直接失敗） |
...
| 項目 | 結果 |
|---|---|
| 關卡資料驗證 | `validate_levels.py`：**50 個檔案全部 OK**（500 個目標，每關 10 個） |
| 標註品質 | 50 關全部做過人工複核 overlay：每個命中框都貼在目標上（卷一～卷五五張拼圖） |
| Web API / DB 端到端 | `npm run smoke` → **81/81**（含帳號：同名＝同帳號；含解鎖：跳關會被 403 擋下；含排名與重置） |
| Web 真實瀏覽器操作 | `npm run ui-check` → **53/53**（50 張卡分五卷、新帳號只有第 1 章能點、放大後點擊仍命中正確目標、重置後重新上鎖） |
...
| Android 建置 | `gradlew assembleDebug` / `assembleRelease` → BUILD SUCCESSFUL（debug 約 42 MB、release 約 37 MB，已簽署；含 100 張相片素材） |
