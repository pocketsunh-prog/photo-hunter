...
| **卷六・活屍尋蹤** | 第 51–60 章 | 現代日常場景（咖啡館、商場、市集、酒吧巷、音樂祭） | **活屍與活屍物件**（活屍、骷髏頭、繃帶斷臂、血手印、白骨…） |
| **卷七・妖精尋蹤** | 第 61–70 章 | 現代街景與咖啡座（巴黎、羅馬、市集、商場中庭） | **妖精**（發光帶翅的小妖精、與人同高的蝶翼妖精） |
| **卷八・地底尋物** | 第 71–80 章 | 奇幻天堂場景（雲端花園、雲上聖殿與書閣） | **地底／墳墓物件**（鐵鍬、鎖鏈、腳鐐、麻布袋、鳥籠、鐵鎚、棺板、墓碑、骷髏…） |

> **目前狀態**：八卷共 **80 章** 全部完成並在兩個 App 上運作（卷一～卷八各 100 個目標，共 800 個）。
...
卷三（第 21–30 章）、卷四（第 31–40 章）與卷八（第 71–80 章）的關卡地圖與標註複核：

| Web 版 80 章地圖 | 卷七標註複核 | 卷八標註複核 |
|---|---|---|
| ![web 80 章](docs/screenshots/web-16-maps-80.png) | ![卷七複核](docs/screenshots/annotation-check-volume-7.jpg) | ![卷八複核](docs/screenshots/annotation-check-volume-8.jpg) |
...
卷六已標註完成的 10 關（第 51–60 章，現代場景裡找活屍與活屍物件）：

![卷六標註複核](docs/screenshots/annotation-check-volume-6.jpg)

卷七已標註完成的 10 關（第 61–70 章，現代街景裡找妖精）：

![卷七標註複核](docs/screenshots/annotation-check-volume-7.jpg)

卷八已標註完成的 10 關（第 71–80 章，天堂場景裡找地底／墳墓物件）：

![卷八標註複核](docs/screenshots/annotation-check-volume-8.jpg)
...
images6/                       卷六 10 張（現代日常場景，活屍與活屍物件）
images7/                       卷七 10 張（現代街景，妖精）
image8/                        卷八 10 張（天堂場景，地底／墳墓物件）
shared/
  levels/level-XX.json         關卡資料：卷別、標題、年代、10 個目標、命中框（唯一真相來源）
  levels/SCHEMA.md             資料格式說明
  assets/images/*.jpg          出貨用相片 1440×1920 + 360×480 縮圖（160 張）
...
**卷六・活屍尋蹤**（現代日常場景裡找活屍與活屍物件，第 51–60 章）：

| 章 | 標題 | 照片場景 | 找到的目標（例） | 相片 |
|---|---|---|---|---|
| 51 | 第五十一章・咖啡館中的活屍 | 老式大咖啡館 | 活屍×6、大理石桌骷髏頭、垃圾桶骷髏頭、琴鍵血跡、琴凳繃帶斷臂 | `images6/生成吉卜力风格古代照片.png` |
| 52 | 第五十二章・運河船上的活屍 | 阿姆斯特丹運河 | 船上活屍×3、紙箱骷髏活屍、垃圾桶蓋骷髏頭、櫥窗活屍、血跡帆布包… | `…(1).png` |
| 53 | 第五十三章・海濱步道的活屍 | 海濱步道 | 蹲踞活屍、櫥窗活屍臉、花盆骷髏頭、紙箱斷臂、繃帶斷手、血手印… | `…(2).png` |
| 54 | 第五十四章・商場裡的活屍 | 購物商場 | 活屍×6、骷髏骸骨、染血紙箱、血淋淋斷肢、血袋 | `…(3).png` |
| 55 | 第五十五章・廣場咖啡座的活屍 | 羅馬式廣場 | 櫥窗活屍、紙箱旁活屍、骷髏頭×2、斷手斷臂、血跡斷骨… | `…(4).png` |
| 56 | 第五十六章・市集活屍漫步 | 倫敦市集 | 活屍×4、櫥窗骷髏怪人、骷髏頭×4、骷髏手掌標本 | `…(5).png` |
| 57 | 第五十七章・石板街上的活屍 | 布拉格老城 | 活屍×5、紅骷髏頭、白骨頭顱、血紅斷掌、斷肢殘肉 | `…(6).png` |
| 58 | 第五十八章・酒吧巷弄活屍夜 | 倫敦酒吧巷 | 活屍×6、腐爛骨手、血斑背包、染血骷髏頭 | `…(7).png` |
| 59 | 第五十九章・活屍音樂祭 | 戶外音樂祭 | 坐屍、白斗篷血屍、染血背包、繃帶斷臂、骷髏旗、白骨遺骸… | `…(8).png` |
| 60 | 第六十章・咖啡座上的活屍 | 巴黎街邊咖啡座 | 活屍×4、花盆骷髏頭、路燈斷手、枝間斷手、血手印、血痕 | `…(9).png` |

> 註：卷六的目標混合「活屍本人」與「活屍物件」（骷髏頭、斷肢、血跡、白骨…），
> 一關大約 3–7 隻活屍加上其餘物件。第 55 章的照片明確可辨的活屍物件較少，
> 其中兩項是低信心判讀（`confidence: "low"`、`reason` 有寫明）。

**卷七・妖精尋蹤**（現代街景裡找妖精，第 61–70 章）：

| 章 | 標題 | 照片場景 | 找到的妖精（例） | 相片 |
|---|---|---|---|---|
| 61 | 第六十一章・街角咖啡館的翅影 | 巴黎街角咖啡館 | 花箱金翼妖精、櫥窗發光妖精、陽傘兩緣妖精、街燈巨翅妖精、帆布袋妖精… | `images7/生成吉卜力风格古代照片.png` |
| 62 | 第六十二章・花市草坪的翅影 | 週末花市 | 花冠蝶翼妖精、綠裙妖精、花叢發光妖精、玫瑰旁發光妖精… | `…(1).png` |
| 63 | 第六十三章・晴空下的海濱妖精 | 海濱步道 | 棕櫚葉大妖精、燈柱小妖精、上空飛翼妖精、人群粉翅妖精… | `…(2).png` |
| 64 | 第六十四章・酒館巷弄的妖精 | 都柏林酒館巷 | 天空白翼妖精、招牌前蝶翼妖精、花冠少女蝶翼妖精、酒桶旁綠妖精… | `…(3).png` |
| 65 | 第六十五章・噴泉廣場的妖精 | 羅馬噴泉廣場 | 噴泉金翼妖精、右牆紫翼妖精、藤椅綠翼妖精、花台大翅妖精… | `…(4).png` |
| 66 | 第六十六章・運河橋畔的妖精 | 阿姆斯特丹運河橋 | 綠裙花冠蝶翼妖精、橋洞發光妖精、船頭金翅妖精、花籃妖精… | `…(5).png` |
| 67 | 第六十七章・老街拱門覓妖精 | 老街拱門 | 綠牆三窗妖精、拱門巨翅妖精、尖帽紫翅妖精、石磚路低飛妖精… | `…(6).png` |
| 68 | 第六十八章・咖啡館裡的妖精 | 美好年代咖啡館 | 圓柱發光妖精、窗簾妖精、蝶翼妖精×3、紙箱裡的發光妖精… | `…(7).png` |
| 69 | 第六十九章・玻璃中庭的妖精 | 商場玻璃中庭 | 螺旋翅妖精、金翅妖精、盆栽紫翼妖精、花冠女子巨翅妖精… | `…(8).png` |
| 70 | 第七十章・黃昏燈串市集 | 倫敦黃昏市集 | 遮棚吊掛妖精、鳥籠旁綠翅妖精、人群中葉翼妖精、麻布袋金翼妖精… | `…９.png` |

> 註：卷七的目標**只算妖精本人**（發光的小妖精、與人同高的蝶翼妖精），
> 蘑菇、花冠、燈串、燈籠這些「妖精裝飾」一律不列為目標。
> 第 63、65、66、70 章的照片裡明確可辨的妖精少於 10 隻（第 66、70 章只有 7 隻很確定），
> 因此這幾關有幾項是 `confidence: "low"` 的判讀，`reason` 有寫明依據。

**卷八・地底尋物**（天堂場景裡找地底／墳墓物件，第 71–80 章）：

| 章 | 標題 | 照片場景 | 找到的地底物件（例） | 相片 |
|---|---|---|---|---|
| 71 | 第七十一章・雲端花園之墓 | 雲端花園 | 鐵鍬、粗鐵鏈、麻布錢袋、雲端鐵鎚、雲海鐵錨、木棺板、鳥籠、大鑰匙、骷髏頭、墓碑石 | `image8/生成吉卜力风格古代照片.png` |
| 72 | 第七十二章・雲上花園的墓影 | 雲上花園與石橋 | 鳥籠、石十字墓碑、麻布袋、骷髏頭、古銅鑰匙、鐵錨、腳鐐、十字鎬、油燈、鏟子 | `…(1).png` |
| 73 | 第七十三章・天堂花園的墓影 | 天堂花園階梯 | 鐵鳥籠、石柱骷髏、鐵鍬、麻布袋、木槌、古銅鑰匙、長鎖鏈、鐵錨、鎖環、木墓碑 | `…(2).png` |
| 74 | 第七十四章・天堂花園的墓痕 | 城堡與雲海 | 骷髏雕飾、鐵鳥籠、大鑰匙、提燈、麻布袋、長柄鐵鍬、大鐵鎚、鎖鏈×3 | `…(3).png` |
| 75 | 第七十五章・雲端花園的墓物 | 浮空島與噴泉 | 骷髏頭、鳥籠、石十字架×2、骨灰罈、鐵鏈鐵球、麻布袋、鐵鍬、鑰匙、棺木板 | `…(4).png` |
| 76 | 第七十六章・雲上樂園的墓影 | 岩洞與水池 | 骷髏與交叉骨、小骷髏頭、鐵鳥籠、木棺板、麻布袋、鐵鎖鏈、鐵木槌、鐵鍬、腳鐐、鐵鍊 | `…(6).png` |
| 77 | 第七十七章・雲階下的墓物 | 雲階聖殿 | 雕刻骷髏頭、骷髏交叉骨浮雕、鐵鳥籠、黃銅掛燈、方形墓石、麻布袋、鐵鎬、鐵鍊、鏟頭、鐵鎖 | `…(7).png` |
| 78 | 第七十八章・雲上書閣的墓物 | 雲端書閣 | 骷髏浮雕、鐵鎖鏈、鐵鳥籠、鐵鏟、麻布袋、古銅鑰匙、鐵鎚、鐵鍊、刻字木板、黃銅油燈 | `…(8).png` |
| 79 | 第七十九章・聖殿雲階埋幽物 | 巴洛克雲上聖殿 | 鳥籠、墓園提燈、骷髏、木十字架、鐵鍬、鎖鏈腳鐐、長鐵鏈、麻布小袋與大袋、石槌與棺板 | `…(9).png` |
| 80 | 第八十章・金廊花園藏墓物 | 金廊花園 | 骷髏浮雕×2、鐵鏟×2、麻布袋×2、粗鐵鏈、鐵鐐銬、大鐵鎚、空鳥籠 | `…(10).png` |

> 註：卷八的目標是**屬於墳墓、埋葬、挖掘與地底的東西**（鐵鍬、鎖鏈、腳鐐、麻布袋、
> 鳥籠、鐵鎚、棺板、墓碑、骷髏、鑰匙、鐵錨、油燈…），天使、光環、翅膀、花、鴿子、
> 雲、噴泉與欄杆一律不列為目標。第 79 章的照片其實是**雲上聖殿室內**（不是戶外花園），
> 標題與副標已照實調整。
...
| 指令 | 用途 |
|---|---|
| `py tools/prepare_assets.py` | 把 `images/`（卷一）到 `image8/`（卷八）八個資料夾的原始相片轉成 1440×1920 主圖 + 360×480 縮圖，並同步到 web 與 android；缺相片會警告並跳過（`--strict` 則直接失敗） |
...
| 項目 | 結果 |
|---|---|
| 關卡資料驗證 | `validate_levels.py`：**80 個檔案全部 OK**（800 個目標，每關 10 個） |
| 標註品質 | 80 關全部做過人工複核 overlay：每個命中框都貼在目標上（卷一～卷八八張拼圖） |
| Web API / DB 端到端 | `npm run smoke` → **81/81**（含帳號：同名＝同帳號；含解鎖：跳關會被 403 擋下；含排名與重置） |
| Web 真實瀏覽器操作 | `npm run ui-check` → **53/53**（80 張卡分八卷、新帳號只有第 1 章能點、放大後點擊仍命中正確目標、重置後重新上鎖） |
...
| Android 建置 | `gradlew assembleDebug` / `assembleRelease` → BUILD SUCCESSFUL（debug 約 62 MB、release 約 56 MB，已簽署；含 160 張相片素材） |
